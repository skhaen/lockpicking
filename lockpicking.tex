...
\chapter{\label{exercices}Exercices}
...
%%%%%%%%%%%%%%%%%%%% chapitre 9
\chapter{\label{faiblesses_serrure}Reconnaître et exploiter les faiblesses des serrures}
