...
\location{Chaos Computer Club - Camp 2011}
\date{\today}
...
\noindent En aucun cas, nous ne pourrions être tenu pour responsable de l’emploi illégal de ces méthodes d’ouverture. \\

{\centering \section*{AVERTISSEMENT}}

\noindent Le contenu de ce manuel est diffusé uniquement à titre documentaire. \\

\noindent En aucun cas, les traducteurs ne pourraient être tenus pour responsable de l’emploi illégal des méthodes d’ouverture décrites dans ce manuel.\\
